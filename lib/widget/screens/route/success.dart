...
class SuccessAnimationPagetwo extends StatefulWidget {
  const SuccessAnimationPagetwo({super.key});

  @override
  State<SuccessAnimationPagetwo> createState() => _SuccessAnimationPageState();
}

class _SuccessAnimationPageState extends State<SuccessAnimationPagetwo> with SingleTickerProviderStateMixin {
...
/*Future<void> updateParkingSlotStatus(BuildContext context, {String status = 'BOOKED'}) async {
  ...
  Future<void> releaseSlot(BuildContext context) async {
    ...
    String baseUrl = 'http://localhost:8080/api/parking-slots/$slotId/release';
